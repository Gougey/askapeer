...
*(EPIC-B's other flagged item, moderator-forced rename, is covered in §1.4 above. The expulsion/re-registration gap and the tag-follow mechanism are both resolved — see §2.)*
