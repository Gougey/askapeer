...
*(EPIC-B's other flagged item, moderator-forced rename, is covered in §1.4 above. The handle length/character rules, the expulsion/re-registration gap, and the tag-follow mechanism are all resolved — see §2.)*
